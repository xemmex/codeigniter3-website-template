...
/* tabify */
(function(a){a.fn.extend({tabify:function(d){function b(e){hash=a(e).find("a").attr("href");return hash}function c(e){a(e).addClass("active");a(b(e)+":hidden").show(0);a(e).siblings("li").each(function(){a(this).removeClass("active");a(b(this)).hide()})}return this.each(function(){var f=this;var e={ul:a(f)};a(this).find("li a").each(function(){a(this).attr("href",a(this).attr("href"))});function g(){if(location.hash&&a(f).find("a[href="+location.hash+"]").length>0){c(a(f).find("a[href="+location.hash+"]").parent())}}if(location.hash){g()}setInterval(g,80);a(this).find("li").each(function(){if(a(this).hasClass("active")){a(b(this)).show(0)}else{a(b(this)).hide()}});if(d){d(e)}})}})})(jQuery);
