...
class Datatables
{
     ...
     * @return mixed
     */
    public function join ( $table, $fk, $type = NULL, $backtick_protect = TRUE )
    {
	$this->joins[] = array( $table, $fk, $type, $backtick_protect );
	$this->ci->db->join ( $table, $fk, $type, $backtick_protect );
	return $this;
    }
	...
	$sSearch = $this->ci->db->escape_str ( trim ( $search['value'] ) );
